                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Menu <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('name_get_menu')}}">Menu List</a></li>
                                    <li><a>Add Menu <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="sub_menu">
                                                <a href="{{route('name_show_create_menu')}}">Menu</a>
                                                <a href="{{route('name_show_create_sub_menu')}}">Sub Menu</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
...
<!-- FastClick -->
<script src="{{asset('CMS/cms/vendors/fastclick/lib/fastclick.js')}}"></script>
<!-- NProgress -->
<script src="{{asset('CMS/cms/vendors/nprogress/nprogress.js')}}"></script>
<!-- Chart.js -->
